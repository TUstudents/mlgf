...
from mlgf.lib.helpers import get_sigma_from_ml
...
class KRROrchestrator:
    ...
    def predict_ij(self, dset, exclude_core, coulomb_screen_tol = None, return_cov = False):
        ...
        for i, xij in enumerate(chunks):
            ...
            yij = predict_joblib(self.model_ij, self.transformer_xij.transform(xij), max_mem = self.max_mem)
